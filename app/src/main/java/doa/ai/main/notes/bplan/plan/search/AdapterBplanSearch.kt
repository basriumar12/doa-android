...
class AdapterBplanSearch(private val businessPlan: MutableList<PlanListResult>, private val context: Context?,

                         val showToolbar: (PlanListResult) -> Unit
) : RecyclerView.Adapter<AdapterBplanSearch.ViewHolder>() {
    ...
    fun setOnItemClickListener(mItemClickListener: AdapterBplanSearch.OnItemClickListener) {

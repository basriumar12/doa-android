...
class IdeationArchiveFragment : BaseFragment(), IdeationView {


    companion object {
        fun newInstance(): IdeationArchiveFragment {
            return IdeationArchiveFragment()
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ideationPresenter.getDataIdeation("token $tokenLogin", currentPage,"archived")
        ...
        listNotes.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            ...
            override fun onScrollStateChanged(recyclerView: RecyclerView, newState: Int) {
                ...
                if (recyclerView.canScrollVertically(1).not()
                    ...
                    currentPage += 1
                    ideationPresenter.getDataIdeationAfter("token $tokenLogin", currentPage,"archived")
...
//        }
    ...
    override fun showDataIdea(data: MutableList<ResultsItem>?) {
        ...
        if (data?.size == 0){
            ...
            tv_empty_data_ideation.text = "Data Arsip Kosong"
        }

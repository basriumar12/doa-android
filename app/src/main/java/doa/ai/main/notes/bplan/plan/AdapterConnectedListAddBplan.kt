...
import kotlinx.android.synthetic.main.view_connected_list_add_bplan.view.*
import kotlinx.android.synthetic.main.view_requested_list.view.*


class AdapterConnectedListAddBplan (private val item: MutableList<ResultsItemForRequested>, private val contex: Context,
                            val addCollab: (ResultsItemForRequested) -> Unit
                            )
    : RecyclerView.Adapter<AdapterConnectedListAddBplan.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):
            ViewHolder = ViewHolder(LayoutInflater.from(parent.context)
            .inflate(R.layout.view_connected_list_add_bplan, parent, false))
